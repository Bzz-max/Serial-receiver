...
IDLE – Waits for the start of a transmission
START – Detects the start condition
RECEIVE – Collects 8 serial bits into a register
WAIT – Handles invalid or incomplete transmissions
STOP – Signals successful reception of one byte
