...
The receiver monitors a serial input line and processes incoming data using a five-state FSM: <br>
IDLE – Waits for the start of a transmission <br>
START – Detects the start condition <br>
RECEIVE – Collects 8 serial bits into a register <br>
WAIT – Handles invalid or incomplete transmissions <br>
STOP – Signals successful reception of one byte <br>
